        ...
        return new Promise<void>((resolve, reject) => {
            ...
            let request = clientRequest(options, (response) => {
                if (response.statusCode === 301 || response.statusCode === 302) {
                    ...
                    return resolve(
                        this.downloadFile(response.headers.location!, pkg, statusView),
                    );
                }
                ...
                this.handleSuccessfulResponse(pkg, response, statusView)
                    .then((_) => {
                        resolve();
                    })
                    .catch((err) => {
    ...
    private handleSuccessfulResponse(
        ...
        return new Promise<void>((resolve, reject) => {
            ...
            response.on("data", (data) => {
                this.handleDataReceivedEvent(progress, data, statusView);
            });
